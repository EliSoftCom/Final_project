...
OurEmailID = 'tsitsilinav@gmail.com' # giving our Gmail Id  
...
def authenticateGmailAPIs():  
    ...
    if not creds or not creds.valid:  
        if creds and creds.expired and creds.refresh_token:  
            ...
            flow = InstalledAppFlow.from_client_secrets_file('C:\\Py_Projects\\Parser\\webapp\\client_secret_913710585677-oqhdaqnftm7e94lft2cbe4jt08uvpcbv.apps.googleusercontent.com.json', SCOPES) # downloaded credential name  
...
SendMail(ServicesGA, "Zemlyachok_26@mail.ru", "Python Project i.e., This is the subject of Mail we are sendimg!",   
            "Now, this is the body of the email we are writing and we can add only written text here!", []) # calling out default SendMail() function
